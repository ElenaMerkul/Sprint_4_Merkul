...
class MainPage(BasePage):
    ...
    def get_answer_text(self):
        return self.driver.find_element(*MainPageLocators.LOCATOR_RESPONSE).text

    def wait_for_get_answer(self):
        WebDriverWait(self.driver, 25).until(expected_conditions.visibility_of_element_located(MainPageLocators.LOCATOR_RESPONSE))
